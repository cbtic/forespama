$(document).ready(function () {
	...
	$('#codigo_producto_bus').keypress(function(e){
		if(e.which == 13) {
			datatablenew();
			return false;
		}
	...
	$('#descripcion_producto_bus').keypress(function(e){
		if(e.which == 13) {
			datatablenew();
			return false;
		}
	...
	$('#codigo_empresa_bus').keypress(function(e){
		if(e.which == 13) {
			datatablenew();
			return false;
		}
	...
	$('#descripcion_empresa_bus').keypress(function(e){
		if(e.which == 13) {
			datatablenew();
			return false;
		}
...
function datatablenew(){
    ...
    var oTable1 = $('#tblEquivalenciaProducto').dataTable({
        "bServerSide": true,
        "sAjaxSource": "/equivalencia_producto/listar_equivalencia_producto_ajax",
        "bProcessing": true,
...
function modalEquivalenciaProducto(id){
	...
	$.ajax({
			url: "/equivalencia_producto/modal_equivalencia_producto/"+id,
			type: "GET",
			success: function (result) {  
