$(document).ready(function () {
    ...
    $(".upload").on('click', function() {
        ...
        $.ajax({
            ...
            url: "/comprobante/upload_factura_promart",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
...
function datatablenew(){
    ...
    var oTable1 = $('#tblFacturacionPromart').dataTable({
        "bServerSide": true,
        "sAjaxSource": "/comprobante/listar_factura_promart_ajax",
        "bProcessing": true,
        ...
        "fnServerData": function (sSource, aoData, fnCallback, oSettings) {
            ...
            oSettings.jqXHR = $.ajax({
                ...
                "data":{NumeroPagina:iNroPagina,NumeroRegistros:iCantMostrar,
						fecha_inicio:fecha_inicio,fecha_fin:fecha_fin,tipo_documento:tipo_documento, estado:estado,
            ...
            [
				...
				},
                {
					"mRender": function (data, type, row) {
                        ...
                        html += '<button style="font-size:12px" type="button" class="btn btn-sm btn-success" data-toggle="modal" onclick="modalFacturaPromart('+row.id+')" ><i class="fa fa-edit"></i>Detalle</button>'; 
...
function modalFacturaPromart(id){
	
	$(".modal-dialog").css("width","85%");
	$('#openOverlayOpc .modal-body').css('height', 'auto');

	$.ajax({
			url: "/comprobante/modal_factura_promart_detalle/"+id,
			type: "GET",
			success: function (result) {
