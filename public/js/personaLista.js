        ...
        "aoColumnDefs":
            [	
                ...
                "mRender": function (data, type, row) {
					...
					html += '<a href="javascript:void(0)" onclick=eliminarPersona('+row.id+','+row.estado+') class="btn btn-sm '+clase+'" style="font-size:12px;margin-left:10px"><i class="fa fa-eraser" style="font-size:18px;"></i> '+estado+'</a>';
					html += '</div>';
					return html;
                },
                "bSortable": false,
