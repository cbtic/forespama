...
function datatablenew(){
    var oTable1 = $('#tblAfiliado').dataTable({
        ...
        "fnServerData": function (sSource, aoData, fnCallback, oSettings) {
            ...
            var id_tipo_moneda_compra = $('#id_tipo_moneda_compra_bus').val();
			var id_tipo_moneda_venta = $('#id_tipo_moneda_venta_bus').val();
            ...
            oSettings.jqXHR = $.ajax({
                ...
                "data":{NumeroPagina:iNroPagina,NumeroRegistros:iCantMostrar,
						fecha:fecha,id_tipo_moneda_compra:id_tipo_moneda_compra,id_tipo_moneda_venta:id_tipo_moneda_venta,
						_token:_token
                       },
                "success": function (result) {
                    fnCallback(result);
        ...
        "aoColumnDefs":
            [	
                ...
                "mRender": function (data, type, row) {
                    var moneda_compra = "";
					if(row.moneda_compra!= null)moneda_compra = row.moneda_compra;
					return moneda_compra;
                },
                "bSortable": false,
                "aTargets": [1]
                },
                ...
                "mRender": function (data, type, row) {
                	var moneda_venta = "";
					if(row.moneda_venta!= null)moneda_venta = row.moneda_venta;
					return moneda_venta;
                },
                "bSortable": false,
                "aTargets": [2]
                },
				{
					"mRender": function (data, type, row) {
						var valor_compra = "";
						if(row.valor_compra!= null)valor_compra = row.valor_compra;
						return valor_compra;
					},
					"bSortable": false,
					"aTargets": [3]
				...
				},
				{
					"mRender": function (data, type, row) {
						...
						html += '<a href="javascript:void(0)" onclick=eliminarTipoCambio('+row.id+','+row.estado+') class="btn btn-sm '+clase+'" style="font-size:12px;margin-left:10px"><i class="fa fa-eraser" style="font-size:18px;"></i> '+estado+'</a>';
...
function modalTipoCambio(id){
	...
	$.ajax({
			url: "/tipo_cambio/modal_tipo_cambio/"+id,
			type: "GET",
			success: function (result) {  
