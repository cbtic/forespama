...
function datatablenew(){
    ...
    var oTable1 = $('#tblFacturaPromart').dataTable({
        "bServerSide": true,
        "sAjaxSource": "/comprobante/listar_comprobante_promart_ajax",
        "bProcessing": true,
...
function reporteFacturaPromart(){
	...
	location.href = '/comprobante/exportar_factura_promart/'  + fecha_ini + '/' + fecha_fin + '/' + tipo_documento + '/'+ serie + '/'+ numero;
