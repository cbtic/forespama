        ...
        "aoColumnDefs":
            [	
                ...
                "mRender": function (data, type, row) {
					...
					html += '<button style="font-size:12px" type="button" class="btn btn-sm btn-success" data-toggle="modal" onclick="modalVehiculo('+row.id+')" ><i class="fa fa-edit" style="font-size:18px;"></i> Editar</button>';
					html += '<a href="javascript:void(0)" onclick=eliminarVehiculo('+row.id+','+row.estado+') class="btn btn-sm '+clase+'" style="font-size:12px;margin-left:10px"><i class="fa fa-eraser" style="font-size:18px;"></i> '+estado+'</a>';
					html += '</div>';
					return html;
                },
                "bSortable": false,
