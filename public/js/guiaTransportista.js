...
function datatablenew(){
    ...
    var oTable1 = $('#tblGuiaTransportista').dataTable({
        "bServerSide": true,
        "sAjaxSource": "/guia_interna/listar_guia_transportista_ajax",
        "bProcessing": true,
        ...
        "fnServerData": function (sSource, aoData, fnCallback, oSettings) {
            ...
            oSettings.jqXHR = $.ajax({
                ...
                "data":{NumeroPagina:iNroPagina,NumeroRegistros:iCantMostrar,
						fecha:fecha,numero_guia:numero_guia,
						empresa:empresa,placa:placa,estado:estado,
						_token:_token
                       },
            ...
            [
				...
				},
				{
					"mRender": function (data, type, row) {
						...
						html += '<button style="font-size:12px" type="button" class="btn btn-sm btn-success" data-toggle="modal" onclick="modalGuiaTransportista('+row.id+')" ><i class="fa fa-edit"></i> Editar</button>'; 
						
						//html += '<a href="javascript:void(0)" onclick=eliminarGuiaTransportista('+row.id+','+row.estado+') class="btn btn-sm '+clase+'" style="font-size:12px;margin-left:10px"><i class="fa fa-eraser"></i>'+estado+'</a>'; 
...
function modalGuiaTransportista(id){
	
	$(".modal-dialog").css("width","85%");
	$('#openOverlayOpc .modal-body').css('height', 'auto');

	$.ajax({
		url: "/guia_interna/modal_guia_transportista/"+id,
		type: "GET",
		success: function (result) {  
...
/*function eliminarGuiaTransportista(id,estado){
	var act_estado = "";
	if(estado==1){
		act_estado = "Eliminar";
		estado_=0;
