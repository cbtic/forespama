...
function datatablenew() {
    var oTable = $('#tblSolicitud').dataTable({
        "bServerSide": true,
        "sAjaxSource": "/ingreso_vehiculo_tronco/listar_ingreso_vehiculo_tronco_pagos_ajax",
        "bProcessing": true,
        ...
        "fnServerData": function(sSource, aoData, fnCallback, oSettings) {
            ...
            oSettings.jqXHR = $.ajax({
                ...
                "data": {
                    ...
                    fecha_fin:fecha_fin,estado_pago:estado_pago,tipo_empresa:tipo_empresa,
                    _token: _token
                },
                "success": function(result) {
                    fnCallback(result);
...
function DescargarArchivosPagos(){
	...
	location.href = '/ingreso_vehiculo_tronco/exportar_listar_pagos/'+ruc+'/'+empresa+'/'+placa+'/'+tipo_madera+'/'+fecha_inicio+'/'+fecha_fin+'/'+estado_pago+'/'+tipo_empresa;
}
