...
class OrdenCompraController extends Controller
{
    ...
    public function exportar_reporte_comercializacion($empresa_compra, $fecha_inicio, $fecha_fin, /*$fecha_inicio_facturado, $fecha_fin_facturado,*/ $numero_orden_compra_cliente, $situacion, $codigo_producto, $producto, $vendedor, $estado_pedido, $tipo_producto, $canal) {
		...
		array_push($variable, array("N°","Canal","Empresa","Orden Compra","Pedido","Fecha Pedido","Fecha Vencimiento","Fecha Entrega Real",/*"Fecha Facturado",*/"Codigo Interno","Codigo Retail","Descripcion","Precio Unitario","Precio Total","Descuento","Cantidad Pedida","Cantidad Entregada","Cantidad Cancelada","Pendiente Entrega","Vendedor","Estado Pedido"));
		...
		foreach ($data as $r) {
			...
			array_push($variable, array($n++,$r->canal, $r->cliente, $r->numero_orden_compra_cliente, $r->pedido, $r->fecha_orden_compra, $r->fecha_vencimiento, $r->fecha_salida, /*$r->fecha_facturado, */$r->codigo, $r->codigo_empresa, $r->producto, $r->precio, $r->sub_total, $r->descuento, $r->cantidad_requerida, $r->cantidad_despacho, $r->cantidad_cancelada, $pendiente_entrega, $r->vendedor, $r->estado_pedido));
		}
...
class InvoicesExport2 implements FromArray, WithHeadings, WithStyles
{
    ...
    public function headings(): array
    {
        return ["N°", "Canal", "Empresa", "Orden Compra", "Pedido", "Fecha Pedido", "Fecha Vencimiento","Fecha Entrega Real", "Codigo Interno", "Codigo Retail", "Descripcion", "Precio Unitario", "Precio Total", "Descuento", "Cantidad Pedida", "Cantidad Entregada", "Cantidad Cancelada", "Pendiente Entrega", "Vendedor", "Estado Pedido"];
    }
