...
class IngresoVehiculoTroncoTipoMadera extends Model
{
    function getDetalleIngresoVehiculoAcerrado(){
        ...
        where e2.id = ivt.id_empresa_transportista ) 
        end ruc, v.placa, tm.denominacion tipo_madera, ivttm.id_tipo_maderas,
        ...
        and ivttm.estado = '1'
        group by ivttm.id, ruc, razon_social, v.placa, tm.denominacion, ivttm.cantidad, ivt.id_empresa_proveedor
