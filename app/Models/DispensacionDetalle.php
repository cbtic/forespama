...
class DispensacionDetalle extends Model
{
    ...
    function getDetalleDispensacionPdf($id){
        ...
        inner join tabla_maestras tm on dd.id_estado_producto ::int = tm.codigo::int and tm.tipo = '56'
        inner join tabla_maestras tm2 on dd.id_estado_producto ::int = tm2.codigo::int and tm2.tipo = '43'
        inner join marcas m on dd.id_marca = m.id 
        where d.id ='".$id."'";
