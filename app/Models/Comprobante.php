...
class Comprobante extends Model
{
    ...
    public function listar_factura_promart_ajax($p){
		return $this->readFuntionPostgres('sp_listar_promart_factura_paginado',$p);
    }

    public function listar_factura_sodimac_detalle_ajax($p){
		return $this->readFuntionPostgres('sp_listar_comprobante_sodimac_detalle_paginado',$p);
    }
	...
	public function registrar_factura_moneda($serie, $numero, $tipo, $ubicacion, $persona, $total, $descripcion, $cod_contable, $id_v, $id_caja, $descuento, $accion,    $id_user,   $id_moneda, $cantidad,$fecha) {
		...
		$data = DB::select($cad, array($serie, $numero, $tipo, $ubicacion, $persona, $total, $descripcion, $cod_contable, $id_v, $id_caja, $descuento, $accion,     $id_user,  $id_moneda, $cantidad, $fecha));
                                    //( serie,  numero,  tipo,  ubicacion,  persona,  total,  descripcion,  cod_contable,  id_v,  id_caja,  descuento,  accion, p_id_usuario, p_id_moneda)
       // print_r($data); exit();
