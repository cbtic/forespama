...
class Devolucione extends Model
{
    ...
    function getDetalleDevolucionId($codigo_salida){
        ...
        m.denominiacion marca, spd.valor_venta_bruto, spd.precio_venta, spd.valor_venta, spd.id_descuento, spd.descuento, oc.numero_orden_compra_cliente, sp.id_empresa_compra, sp.id_moneda, oc.igv_compra, sp.id id_salida
