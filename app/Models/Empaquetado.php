...
class Empaquetado extends Model
{
    ...
    public function listar_empaquetados_ajax($p){

        return $this->readFuntionPostgres('sp_listar_empaquetados_paginado',$p);
    ...
    function getCodigoEmpaquetado(){

        $cad = "select lpad(coalesce(max(e.codigo::int) + 1, 1)::varchar, 6, '0') codigo
        from empaquetado e";
    ...
    function getDetalleEmpaquetadoById($id){
