...
class EntradaProductoDetalle extends Component
{
    ...
    public function render()
    {
        ...
        if ($this->entradaproductodetalles) {
            ...
            return app(EntradaProductoDetallesForm::class)->viaAjax()->create()->asModal($triggerContent = '+ Nuevo Ingreso de Producto', $triggerClass = 'btn btn-default', $message = null, $modalTitle = 'Ingreso de Producto (Entrada #'.$this->entradaproducto.')');
        }
    }
}
