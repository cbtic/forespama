...
class CreateGuiaTransportistasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('guia_transportistas', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('guia_tarjeta_unica_circulacion')->nullable();
            $table->string('guia_numero_registro_mtc')->nullable();
    ...
    {
        Schema::dropIfExists('guia_transportistas');
    }
}
