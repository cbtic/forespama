-- DROP FUNCTION public.sp_listar_ingreso_produccion_paginado(varchar, varchar, varchar, varchar, varchar, varchar, varchar, refcursor);
...
begin
	...
	left join tabla_maestras tm2 on ip.id_area ::int = tm2.codigo ::int and tm2.tipo = ''81''
