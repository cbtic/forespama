-- DROP FUNCTION public.sp_listar_orden_compra_paginado(varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, refcursor);
...
begin
	...
	(select r.codigo  from requerimientos r where oc.id_requerimiento = r.id) codigo_requerimiento, oc.id_autorizacion, tm3.denominacion prioridad, tm4.denominacion canal ';
	...
	left join tabla_maestras tm4 on oc.id_canal ::int = tm4.codigo ::int and tm4.tipo = ''98''
	...
	If p_estado_pedido_cancelado<>'' Then
	 v_where:=v_where||'And oc.estado_pedido_cancelado = '''||p_estado_pedido_cancelado||''' ';
	End If;
