...
Route::get('kardex/exportar_listar_existencia/{consulta_almacen}/{cantidad_producto}', [KardexController::class, 'exportar_listar_existencia'])->name('kardex.exportar_listar_existencia');
