...
Route::get('kardex/exportar_listar_existencia/{consulta_almacen}/{cantidad_producto}/{fecha}', [KardexController::class, 'exportar_listar_existencia'])->name('kardex.exportar_listar_existencia');
...
Route::get('orden_compra/exportar_listar_orden_compra/{tipo_documento}/{empresa_compra}/{empresa_vende}/{fecha_inicio}/{fecha_fin}/{numero_orden_compra}/{numero_orden_compra_cliente}/{almacen_origen}/{almacen_destino}/{situacion}/{estado}/{vendedor}/{estado_pedido}/{prioridad}/{canal}/{tipo_producto}/{estado_pedido_cancelado}', [OrdenCompraController::class, 'exportar_listar_orden_compra'])->name('orden_compra.exportar_listar_orden_compra');
...
Route::get('productos/exportar_listar_productos/{tipo_origen_producto}/{serie}/{codigo}/{denominacion}/{estado_bien}/{tipo_producto}/{tiene_imagen}/{estado}/{familia}/{sub_familia}/{aprobado}/{familia_contable}/{usuario_inserta}', [ProductosController::class, 'exportar_listar_productos'])->name('orden_compra.exportar_listar_productos');
...
Route::get('orden_compra/exportar_reporte_comercializacion/{empresa_compra}/{fecha_inicio}/{fecha_fin}/{numero_orden_compra_cliente}/{situacion}/{codigo_producto}/{producto}/{vendedor}/{estado_pedido}/{tipo_producto}/{canal}', [OrdenCompraController::class, 'exportar_reporte_comercializacion'])->name('orden_compra.exportar_reporte_comercializacion');
...
Route::get('ingreso_produccion/exportar_listar_ingreso_produccion/{tipo_documento}/{fecha}/{numero_ingreso_produccion}/{almacen_destino}/{area}/{unidad_trabajo}/{estado}', [IngresoProduccionController::class, 'exportar_listar_ingreso_produccion'])->name('ingreso_produccion.exportar_listar_ingreso_produccion');
...
Route::get('orden_compra/exportar_listar_orden_compra_detalle/{tipo_documento}/{empresa_compra}/{empresa_vende}/{fecha_inicio}/{fecha_fin}/{numero_orden_compra}/{numero_orden_compra_cliente}/{almacen_origen}/{almacen_destino}/{situacion}/{estado}/{vendedor}/{estado_pedido}/{prioridad}/{canal}/{tipo_producto}/{estado_pedido_cancelado}', [OrdenCompraController::class, 'exportar_listar_orden_compra_detalle'])->name('orden_compra.exportar_listar_orden_compra_detalle');
