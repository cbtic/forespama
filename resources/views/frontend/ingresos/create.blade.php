                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    $total_recaudado_dolares = "";
                                    $saldo_total_dolares = "";
                                    $disabled_dolares = "disabled='disabled'";

                                    if (isset($caja_usuario) && $caja_usuario->estado == 1):
                                        //print_r($caja_usuario);print_r($caja_usuario_dolares);exit();
                                        ...
                                        $readonly_dolares = "readonly='readonly'";
                                        $disabled_dolares = "";
                                        $saldo_inicial_dolares = number_format($caja_usuario_dolares->saldo_inicial, 2);
                                        $total_recaudado_dolares = number_format($caja_usuario_dolares->total_recaudado, 2);
                                        $saldo_total_dolares = number_format($caja_usuario_dolares->saldo_total, 2);
                                    ?>
                                        <input class="btn btn-warning btn-sm pull-right" value="CERRAR DE CAJA" name="cerrar"
                                            type="button" form="prestacionescrea" id="btnGuardarCaja" onclick="aperturarMoneda('u')" />
                                    <?php else: ?>
                                        <input class="btn btn-warning btn-sm pull-right" value="APERTURA DE CAJA" name="aperturar"
                                            type="button" form="prestacionescrea" id="btnGuardarCaja" onclick="aperturarMoneda('i')" />
                                    <?php endif; ?>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" style="padding:0px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12" style="padding:30px 0px 0px 0px;color:#007bff">
                                        <div class="form-group" style="margin-top:7px;margin-bottom:0px!important">
                                            <label class="form-control-sm">SOLES</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding:0px">
                                        <div class="form-group">
                                            ...
                                            ?>
                                                ...
                                                <input type="hidden" name="id_caja_soles" id="id_caja_soles" value="<?php echo $caja_usuario->id_caja ?>" />
                                                <input type="hidden" name="id_caja_ingreso_soles" id="id_caja_ingreso_soles" value="<?php echo $caja_usuario->id ?>" />
                                            <?php else: ?>
                                                <select name="id_caja_soles" id="id_caja_soles" class="form-control form-control-sm">
                                                    <option value="0">Seleccionar</option>
                                                    <?php foreach ($caja as $row): ?>
                                                        <option value="<?php echo $row->id ?>"><?php echo $row->denominacion ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <input type="hidden" name="id_caja_ingreso_soles" id="id_caja_ingreso_soles" value="0" />
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="saldo_inicial_soles" id="saldo_inicial_soles" <?php echo $readonly ?>
                                                value="<?php echo $saldo_inicial ?>" placeholder=""
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_recaudado_soles" id="total_recaudado_soles"
                                                value="<?php echo $total_recaudado ?>" readonly="" placeholder=""
                                                class="form-control form-control-sm text-right">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="saldo_total_soles" id="saldo_total_soles" value="<?php echo $saldo_total ?>"
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding:0px">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            if (isset($caja_usuario_dolares) && $caja_usuario_dolares->estado == 1):
                                            ?>
                                                <input type="text" name="caja" id="caja" readonly="" value="<?php echo $caja_usuario_dolares->caja ?>" placeholder="" class="form-control form-control-sm">
                                                <input type="hidden" name="id_caja_dolares" id="id_caja_dolares" value="<?php echo $caja_usuario_dolares->id_caja ?>" />
                                                <input type="hidden" name="id_caja_ingreso_dolares" id="id_caja_ingreso_dolares" value="<?php echo $caja_usuario_dolares->id ?>" />
                                            <?php else: ?>
                                                <select name="id_caja_dolares" id="id_caja_dolares" class="form-control form-control-sm">
                                                    <option value="0">Seleccionar</option>
                                                    <?php foreach ($caja_dolares as $row): ?>
                                                        <option value="<?php echo $row->id ?>"><?php echo $row->denominacion ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <input type="hidden" name="id_caja_ingreso_dolares" id="id_caja_ingreso_dolares" value="0" />
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <input type="text" name="saldo_inicial_dolares" id="saldo_inicial_dolares" <?php echo $readonly_dolares ?>
                                                value="<?php echo $saldo_inicial_dolares ?>" placeholder=""
                                                class="form-control form-control-sm text-right">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <input type="text" name="total_recaudado_dolares" id="total_recaudado_dolares"
                                                value="<?php echo $total_recaudado_dolares ?>" readonly="" placeholder=""
                                                class="form-control form-control-sm text-right">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <input type="text" name="saldo_total_dolares" id="saldo_total_dolares" value="<?php echo $saldo_total_dolares ?>"
                                                readonly="" placeholder="" class="form-control form-control-sm text-right">
                                        </div>
                                    </div>
