...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    ...
    <li class="breadcrumb-item active">Consulta de Facturas de Sodimac</li>
    </li>
</ol>
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consultar Facturas de Sodimac<!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong>
                                ...
                                Lista de Facturaci&oacute;n de Sodimac
                            </strong>
                        </div><!--card-header-->

                        <form class="form-horizontal" method="post" action="" id="frmFacturasSodimac" autocomplete="off">
