...
@section('title', __('Consulta de Facturacion'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Consulta de Facturas de Promart</li>
    </li>
</ol>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consultar Facturas de Promart<!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col col-sm-12 align-self-center">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong>
                                ...
                                Lista de Facturaci&oacute;n de Promart
                            </strong>
                        </div><!--card-header-->

                        <form class="form-horizontal" method="post" action="" id="frmFacturasPromart" autocomplete="off">
                            ...
                            <div class="row" style="padding:20px 20px 0px 20px;">
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <input class="form-control form-control-sm" id="fecha_inicio" name="fecha_inicio" value="<?php //echo date("d-m-Y") ?>" placeholder="Fecha Inicio">
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                                    <div class="form-group">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tblFacturacionPromart" class="table table-hover table-sm">
                                        <thead>
                    ...
                    <script src="{{ asset('js/promartFactura.js') }}"></script>
                    @endpush
