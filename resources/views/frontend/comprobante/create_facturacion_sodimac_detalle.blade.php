...
@section('title', __('Consulta de Facturacion Detalle'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Consulta de Facturas de Sodimac Detalle</li>
    </li>
</ol>
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consultar Facturas de Sodimac Detalle<!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong>
                                ...
                                Lista de Facturaci&oacute;n de Sodimac Detalle
                            </strong>
                        </div><!--card-header-->

                        <form class="form-horizontal" method="post" action="" id="frmFacturasSodimacDetalle" autocomplete="off">
                            ...
                            <div class="row" style="padding:20px 20px 0px 20px;">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <input class="form-control form-control-sm" id="numero_documento_bus" name="numero_documento_bus" value="" placeholder="N&uacute;mero Documento">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <select name="tipo_documento_cobro_bus" id="tipo_documento_cobro_bus" class="form-control form-control-sm">
                                        <option value="">--Seleccionar Tipo Documento Cobro--</option>
                                        <?php
                                        foreach ($tipo_documento_cobro as $row){?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tblFacturacionSodimacDetalle" class="table table-hover table-sm">
                                        <thead>
                                            <tr style="font-size:13px">
                                                <th>Id</th>
                                                <th>Id Factura Sodimac</th>
                                                <th>Tipo Documento Cobro</th>
                                                <th>N&uacute;mero Documento</th>
                                                <th>Moneda</th>
                                                <th class="text-right">Importe Inicial</th>
                                                <th class="text-right">Importe Retenci&oacute;n</th>
...
<!--                     
                    ...
                    <script src="{{ asset('js/sodimacFacturaDetalle.js') }}"></script>
                    @endpush
