...
@section('title', __('Facturas Promart'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Consulta de Comprobantes Promart</li>
    </li>
</ol>
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consultar Facturas Promart<!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col col-sm-12 align-self-center">
                    ...
                    <div class="card">
                        ...
                        <form class="form-horizontal" method="post" action="" id="frmComprobantePromart" autocomplete="off">
                            ...
                            <div class="row" style="padding:20px 20px 0px 20px;">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding-right:0px">
                                    ...
                                    <button id="btnExcel" type="button" class="btn btn-secondary pull-rigth" style="margin-left:15px;" onclick="reporteFacturaPromart()">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tblFacturaPromart" class="table table-hover table-sm">
                                        <thead>
...
<!--                     
                    ...
                    <script src="{{ asset('js/FacturaPromartLista.js') }}"></script>
                    @endpush
