...
function fn_save_asistencia_promotor(){
    ...
    if(msg!=""){
        ...
        .css("width", "100vw")
        .css("height", "100vh")
        .html("<div id='Grd1_processing'>Marcando salida, espere un momento...</div>")
        .show();
...
<div class="card">
    ...
    <div class="card-body">
    <form method="post" action="#" id="frmAsistenciaPromotorSalida" name="frmAsistenciaPromotorSalida">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:5px;padding-bottom:20px">
        ...
        <div class="row" style="padding-left:10px">
            ...
            <div class="col-lg-10">
                <select name="id_tienda_salida" id="id_tienda_salida" class="form-control form-control-sm" onchange="">
            ...
            <div style="margin-top:15px" class="form-group">
                <div class="col-sm-12 controls">
                    <div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
                        ...
                        <button type="button" style="font-size:12px;margin-left:10px" class="btn btn-sm btn-clasico btn-nuevo" data-toggle="modal" onclick="fn_save_asistencia_promotor()">
