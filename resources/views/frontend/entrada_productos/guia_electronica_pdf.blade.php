    ...
    <table style="width: 100%; border-collapse: separate; border-spacing: 0;">
        <tr>
            ...
            <th style="text-align: center; border: solid 2px black; padding: 0px; border-radius: 8px; background-color: white; vertical-align: top; width: 50%">
                ...
                <p style="font-size: 20px; margin: 10; line-height: 1;">003.- N° 001973</p>
            </th>
        </tr>
    </table>
    ...
    <table style="width: 100%; border-collapse: separate; border-spacing: 0 10px;">
        <tr>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia">Punto de partida:</p>
            </th>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia">Punto de llegada:</p>
            </th>
        </tr>
        <tr>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia">Fecha de Inicio de Traslado:</p>
            </th>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia">DESTINATARIO:</p>
                <p class="info-guia">R.U.C.:</p>
            </th>
        </tr>
        <tr>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                ...
                <p class="info-guia">Marca y numero de placa:</p>
                <p class="info-guia">N° de Contancia de Inscripcion:</p>
                <p class="info-guia">N° (s) de Licencia(s) de Conducir:</p>
            </th>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia" style="text-align: center; font-size: 11px"><b>EMPRESA DE TRANSPORTES</b></p>
                <div style="border-top: 1px solid black; margin: 5px 0; width: 100%;"></div>
                <p class="info-guia">RAZON SOCIAL:</p>
                <p class="info-guia">Numero de R.U.C.:</p>
            </th>
        </tr>
    </table>
