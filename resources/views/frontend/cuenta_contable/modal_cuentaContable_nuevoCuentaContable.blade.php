...
function fn_save_cuenta_contable(){
	...
	$.ajax({
        url: "/cuenta_contable/send_cuenta_contable",
        type: "POST",
        data : $("#frmCuentaContable").serialize(),
    ...
    <div>
		...
		<div class="justify-content-center">		
            ...
            <div class="card">
                ...
                <div class="card-body">
                <form method="post" action="#" id="frmCuentaContable" name="frmCuentaContable">
                            ...
                            <div class="row" style="padding-left:10px">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="tipo" id="tipo" class="form-control form-control-sm" onchange="">
                                            ...
                                            <?php
                                            foreach ($tipo as $row){?>
                                                <option value="<?php echo $row->codigo; ?>" <?php echo ($id > 0 && $row->codigo == $cuenta_contable->id_tipo) ? "selected='selected'" : ""; ?>><?php echo $row->denominacion ?></option>
                                                <?php 
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <input id="denominacion" name="denominacion" on class="form-control form-control-sm" value="<?php echo $cuenta_contable->denominacion?>" type="text" style="text-transform: uppercase;">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
