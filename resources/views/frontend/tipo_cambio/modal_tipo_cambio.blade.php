					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select name="id_tipo_moneda_compra" id="id_tipo_moneda_compra" class="form-control form-control-sm">
									<option value="">--Selecionar--</option>
									<?php
									foreach ($tipo_moneda as $row) { ?>
										<option value="<?php echo $row->codigo ?>" <?php if($tipoCambio->id_tipo_moneda_compra==$row->codigo)echo "selected='selected'"?>><?php echo $row->denominacion ?></option>
									<?php
									}
									?>
								</select>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select name="id_tipo_moneda_venta" id="id_tipo_moneda_venta" class="form-control form-control-sm">
									<option value="">--Selecionar--</option>
									<?php
									foreach ($tipo_moneda as $row) { ?>
										<option value="<?php echo $row->codigo ?>" <?php if($tipoCambio->id_tipo_moneda_venta==$row->codigo)echo "selected='selected'"?>><?php echo $row->denominacion ?></option>
									<?php
									}
									?>
								</select>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group" style="padding-top:0px;padding-bottom:0px;margin-top:0px;margin-bottom:0px">
								...
								<input id="valor_compra" name="valor_compra" class="form-control form-control-sm"  value="<?php echo $tipoCambio->valor_compra?>" type="text">
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group" style="padding-top:0px;padding-bottom:0px;margin-top:0px;margin-bottom:0px">
								...
								<input id="valor_venta" name="valor_venta" class="form-control form-control-sm" value="<?php echo $tipoCambio->valor_venta?>" type="text">
							</div>
						</div>
