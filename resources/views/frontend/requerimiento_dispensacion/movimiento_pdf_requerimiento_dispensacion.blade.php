        ...
        <div class="contenido">
            ...
            <table class="data" style="width:100%; background-color:white !important;border-spacing:1px; width: 100%; margin: 0 auto; font-size:12px; vertical-align:top">
                <tbody>
                    ...
                    <tr>
                        <td class="td" style ="text-align: left; width: 10%;"><b>Sede:</b></td>
                        <td class="td" style ="text-align: left; width: 20%;"><?php echo $sede;?></td>
                        <td class="td" style ="text-align: left; width: 10%;"></td>
                        <td class="td" style ="text-align: left; width: 10%;"><b>Centro de Costo:</b></td>
                        <td class="td" style ="text-align: left; width: 20%;"><?php echo $centro_costo;?></td>
                    </tr>
                    <tr>
