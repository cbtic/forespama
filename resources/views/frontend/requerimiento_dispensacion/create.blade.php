...
@section('title', __('Requerimiento de Insumos'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Requerimientos de Insumos</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmRequerimientoDispensacion" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center" style="margin-top:15px">
						...
						<div class="row">
							<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
								<div class="row">
									...
									<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
										<input id="numero_requerimiento_dispensacion_bus" name="numero_requerimiento_dispensacion_bus" on class="form-control form-control-sm filtro-input"  placeholder="N&uacute;mero requerimiento insumo">
									</div>
					...
					<div class="card-body">
						...
						<table id="tblRequerimientoDispensacion" class="table table-hover table-sm">
							<thead>
...
@endsection
	...
	<script src="{{ asset('js/requerimientoDispensacion.js') }}"></script>
