        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmRequerimiento" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
						<select name="tipo_requerimiento_bus" id="tipo_requerimiento_bus" class="form-control form-control-sm">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding-right:0px">
						...
						<buttom class="btn btn-secondary btn-sm pull-rigth" type="button" id="btnDescargar"/><i class="fa fa-download"></i>Descargar</buttom>
					</div>
				</div>
