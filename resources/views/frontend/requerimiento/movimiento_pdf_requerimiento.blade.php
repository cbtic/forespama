            ...
            <table class="data" style="width:100%; background-color:white !important;border-spacing:1px; width: 100%; margin: 0 auto; font-size:12px; vertical-align:top">
                <tbody>
                    <tr>
                        ...
                        <td class="td" style ="text-align: left; width: 15%;"><b>Almacen Solicitante:</b></td>
                        <td class="td" style ="text-align: left; width: 20%;"><?php echo $almacen;?></td>
                    </tr>
                    <tr>
                        <td class="td" style ="text-align: left; width: 15%;"><b>Responsable de Atenci&oacute;n:</b></td>
                        <td class="td" style ="text-align: left; width: 20%;"><?php echo $responsable_atencion;?></td>
                        <td class="td" style ="text-align: left; width: 10%;"></td>
            ...
            <table class="data" style="border-collapse: separate; border-spacing: 0; background-color:white !important; width: 100%; border-radius: 8px; font-size:11px">
                <tbody>
                    <tr class="data">
                        ...
                        <td class="td" style ="text-align: left; width: 17%; height:25px; border-bottom: 1px solid black;"><b>DESCRIPCI&Oacute;N</b></td>
                        ...
                        <td class="td" style ="text-align: left; width: 8%; height:25px; border-bottom: 1px solid black;"><b>CANTIDAD</b></td>
                        <td class="td" style ="text-align: left; width: 12%; height:25px; border-bottom: 1px solid black;"><b>PERSONA SOLICITA</b></td>
                        <td class="td" style ="text-align: left; width: 10%; height:25px; border-bottom: 1px solid black;"><b>PRIORIDAD</b></td>
                    ...
                    foreach($datos_detalle as $key=>$r) { ?>
                        <tr>
                            ...
                            <td class="td" style ="text-align: left; width: 17%; height:25px"><?php echo $r->producto;?></td>
                            ...
                            <td class="td" style ="text-align: center; width: 8%; height:25px"><?php echo $r->cantidad;?></td>
                            <td class="td" style ="text-align: left; width: 12%; height:25px"><?php echo $r->usuario;?></td>
                            <td class="td" style ="text-align: left; width: 10%; height:25px"><?php echo $r->prioridad;?></td>
