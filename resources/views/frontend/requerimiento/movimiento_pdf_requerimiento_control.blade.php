...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <table class="data" style="width:100%; font-size:11px">
        <tr>
            <th><h2>CONTROL DE <?php echo $tipo_documento ." N° ". $codigo;?></h2></th>
        </tr>
    </table>
            ...
            <table class="data" style="border-collapse: separate; border-spacing: 0; background-color:white !important; width: 100%; border-radius: 8px; font-size:11px">
                <tbody>
                    <tr class="data">
                        ...
                        <td class="td" style ="text-align: left; width: 10%; height:25px; border-bottom: 1px solid black;"><b>CANTIDAD REQUERIDA</b></td>
                        <td class="td" style ="text-align: left; width: 10%; height:25px; border-bottom: 1px solid black;"><b>CANTIDAD ATENDIDA</b></td>
                        <td class="td" style ="text-align: left; width: 10%; height:25px; border-bottom: 1px solid black;"><b>N° ORDEN COMPRA</b></td>
                    </tr>
                    ...
                    foreach($datos_detalle as $key=>$r) { ?>
                        <tr>
                            ...
                            <td class="td" style ="text-align: left; width: 27%; height:25px"><?php echo $r->nombre_producto;?></td>
                            ...
                            <td class="td" style ="text-align: center; width: 10%; height:25px"><?php echo $r->cantidad_atendida;?></td>
                            <td class="td" style ="text-align: left; width: 10%; height:25px"><?php echo $r->orden_compra;?></td>
                            <?php 
                            ?>
                        </tr>
                    <?php }
