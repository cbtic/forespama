...
function fn_save_motivo(){
    ...
    if(msg!=""){
        ...
        $.ajax({
            url: "/requerimiento/send_cerrar_antiguedad_requerimiento",
            type: "POST",
            data : $("#frmCerrarAntiguedadRequerimiento").serialize(),
		...
		<div class="justify-content-center">
            ...
            <div class="card">
                ...
                <div style="text-align: center; font-size:16px; margin-top: 20px">
                    <b>Cerrar Requerimiento por Antiguedad</b>
                </div>
                
                <div class="card-body">
                <form method="post" action="#" id="frmCerrarAntiguedadRequerimiento" name="frmCerrarAntiguedadRequerimiento">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:5px;padding-bottom:20px">
                    ...
                    <div class="row" style="padding-left:10px">
                        ...
                        <div class="col-lg-12" style="padding-top:20px">
                            <label class="control-label form-control-sm">Motivo</label>
                    ...
                    <div style="margin-top:15px" class="form-group">
                        <div class="col-sm-12 controls">
                            <div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
                                ...
                                <!--<a href="javascript:void(0)" onClick="fn_save_motivo()" class="btn btn-sm btn-success" style="margin-right:10px">Guardar</a>-->
                                <button type="button" style="font-size:12px;margin-left:10px" class="btn btn-sm btn-clasico btn-nuevo" data-toggle="modal" onclick="fn_save_motivo()">
