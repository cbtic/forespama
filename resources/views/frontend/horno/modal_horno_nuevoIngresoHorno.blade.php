            ...
            result.detalle_acerrado.forEach(detalle_acerrado => {
                ...
                const row = `
                    <tr>
                        ...
                        <td><input name="id_tipo_madera[]" id="id_tipo_madera${n}" class="form-control form-control-sm" value="${detalle_acerrado.id_tipo_madera}" type="hidden"><input name="tipo_madera[]" id="tipo_madera${n}" class="form-control form-control-sm" style="border: none; background-color: transparent;" value="${detalle_acerrado.tipo_madera}" type="text" readonly></td>
                        <td><input name="id_medida[]" id="id_medida${n}" class="form-control form-control-sm" value="${detalle_acerrado.id_medida}" type="hidden"><input name="medida[]" id="medida${n}" class="form-control form-control-sm" style="border: none; background-color: transparent;" value="${detalle_acerrado.medida}" type="text" readonly></td>
                        <td><input name="cantidad_paquete[]" id="cantidad_paquete${n}" class="cantidad_paquete form-control form-control-sm" style="border: none; background-color: #96D299; font-weight: bold;" value="${detalle_acerrado.cantidad_paquetes}" type="text" readonly></td>
                            ...
                            <div style="margin-top:15px" class="form-group">
                                <div class="col-sm-12 controls">
                                    <div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
                                        ...
                                        <button type="button" style="font-size:12px;margin-left:10px" class="btn btn-sm btn-clasico btn-nuevo" data-toggle="modal" onclick="fn_save_ingreso_horno()">
