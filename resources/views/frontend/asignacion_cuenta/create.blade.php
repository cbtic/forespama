...
@section('title', __('Consulta Asignacion Cuentas'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Asignaci&oacute;n de Cuentas</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmAsignacionCuenta" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<div class="row">
							...
							<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
								<select name="centro_costo_bus" id="centro_costo_bus" class="form-control form-control-sm filtro-select">
							...
							<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
								<select name="origen_bus" id="origen_bus" class="form-control form-control-sm filtro-select">
                ...
                <div class="card-body">				
                    ...
                    <table id="tblAsignacionCuenta" class="table table-hover table-sm">
                        <thead>
...
<script src="{{ asset('js/asignacion_cuenta.js') }}"></script>
