...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    ...
    <li class="breadcrumb-item active">Registro de Lotes</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmLotes" autocomplete="off" enctype="multipart/form-data">
				<!--
                <div class="row">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<input class="form-control form-control-sm" id="marca_bus" name="marca_bus" placeholder="Marca">
					</div>

					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<input class="form-control form-control-sm" id="anaquel_bus" name="anaquel_bus" placeholder="Anaquel">
					</div>
                ...
                <div class="card-body">				
                    ...
                    <table id="tblLotes" class="table table-hover table-sm">
                        <thead>
                        <tr style="font-size:13px">
                            <th>Id</th>
							<th>Producto</th>
                            <th>Marca</th>
							<th>N&uacute;mero Lote</th>
