                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="competencia" id="competencia" class="form-control form-control-sm">
                                            ...
                                            foreach ($competencia as $row){?>
                                                <option value="<?php echo $row->codigo ?>" <?php if($row->codigo==$producto_competencia->id_competencia)echo "selected='selected'"?>><?php echo $row->denominacion ?></option>
                                                <?php 
                                            }
                                            ?>
                                        </select>
                            ...
                            <div class="row" style="padding-left:10px">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <input id="denominacion" name="denominacion" on class="form-control form-control-sm"  value="<?php echo $producto_competencia->denominacion?>" type="text" style="text-transform: uppercase;">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="control-label form-control-sm">C&oacute;digo</label>
                                        <input id="codigo" name="codigo" on class="form-control form-control-sm"  value="<?php echo $producto_competencia->codigo?>" type="text" style="text-transform: uppercase;">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="margin-top:15px" class="form-group">
                        <div class="col-sm-12 controls">
                            <div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
                                ...
                                <button type="button" style="font-size:12px;margin-left:10px" class="btn btn-sm btn-clasico btn-nuevo" data-toggle="modal" onclick="fn_save_producto_competencia()">
