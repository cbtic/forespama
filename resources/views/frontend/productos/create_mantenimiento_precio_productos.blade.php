...
@section('title', __('Mantenimiento Precio Productos'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Precio de Productos</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmMantenimientoPrecioProductos" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="margin-top:15px">
                        <h4 class="card-title mb-0 text-primary" style="font-size:22px">
                            Mantenimiento Precio Productos
                        </h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <table id="tblMantenimientoPrecioProductos" class="table table-hover table-sm">
                        <thead>
...
@endsection
	...
	<script src="{{ asset('js/mantenimiento_precio_productos.js') }}"></script>
