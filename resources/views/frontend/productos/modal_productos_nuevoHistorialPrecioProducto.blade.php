            ...
            <div class="card">
                ...
                <div class="card-body">
					...
					<div class="table-responsive">
						<table id="tblHistorialPrecio" class="table table-hover table-sm">
							<thead>
							...
							<tbody id="divDetalle">
                            <?php
                            foreach($producto_precio_detalle as $row){
                            ?>
                            <tr>
                                <td class="text-left" style="vertical-align:middle"><?php echo $row->id?></td>
                                <td class="text-left" style="vertical-align:middle"><?php echo $row->producto?></td>
                                <td class="text-left" style="vertical-align:middle"><?php if($row->fecha!=null) {echo date('Y-m-d', strtotime($row->fecha));}else{ echo'';}?></td>
                                <td class="text-left" style="vertical-align:middle"><?php echo $row->precio?></td>
