...
@section('title', __('Reporte Productos'))
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmReporteProductos" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <table id="tblReporteProductos" class="table table-hover table-sm">
                        <thead>
