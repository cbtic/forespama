...
@section('title', __('Consulta Familia Contable'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Familia Contable</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmFamiliaContable" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="row justify-content-center" style="margin-top:15px">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<input id="familia_contable_bus" name="familia_contable_bus" on class="form-control form-control-sm filtro-input"  placeholder="Familia Contable">
							</div>
				...
				<div class="card-body">				
					...
					<table id="tblFamiliaContable" class="table table-hover table-sm">
						<thead>
...
<script src="{{ asset('js/familiaContable.js') }}"></script>
