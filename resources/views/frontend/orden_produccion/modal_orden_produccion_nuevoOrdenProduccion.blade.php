                            ...
                            <div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
                                ...
                                <?php if($id>0){?>
                                    <button style="font-size:12px;margin-left:10px;margin-right:10px" type="button" class="btn btn-sm btn-clasico btn-enviar" data-toggle="modal" onclick="pdf_documento()" >
                                        <i class="far fa-file-pdf" style="font-size:18px;"></i>Imprimir Pdf
                                    </button>
                                    ...
                                    <button style="font-size:12px;margin-left:10px;margin-right:10px" type="button" class="btn btn-sm btn-clasico btn-enviar" data-toggle="modal" onclick="pdf_documento_detallado()" >
                                        <i class="far fa-file-pdf" style="font-size:18px;"></i>Imprimir Pdf Destallado
                                    </button>
                                <?php }?>
