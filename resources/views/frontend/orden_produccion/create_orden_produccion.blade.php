...
@section('title', __('Orden de Fabricacion'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Orden de Compra de Producci&oacute;n</li>
    </li>
</ol>
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmOrdenFabricacion" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-2">
						<select name="cerrado_bus" id="cerrado_bus" class="form-control form-control-sm" onchange="">
							<option value="">--Seleccionar Cerrado--</option>
							<?php
                ...
                <div class="card-body">
                    ...
                    <div id="divOrdenProduccion" class="table-responsive">
                    <table id="tblOrdenProduccion" class="table table-hover table-sm">
                        <thead>
