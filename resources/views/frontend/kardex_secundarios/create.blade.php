...
@section('title', __('Kardex Secundario'))
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmKardexB" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center" style="margin-top:15px">
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
							<div class="row">
								<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
									<select name="almacen_bus" id="almacen_bus" class="form-control form-control-sm filtro-select" onchange="">
					...
					<div class="card-body">				
						...
						<table id="tblKardexSecundario" class="table table-hover table-sm">
							<thead>
...
@endsection
	...
	<script src="{{ asset('js/kardex_secundario.js') }}"></script>
