...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmReporteComercializacionGeneral" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="margin-top:15px">
                        <h4 class="card-title mb-0 text-primary" style="font-size:22px">
							Reporte de Comercializaci&oacute;n General
                        </h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <table id="tblReporteComercializacionGeneral" class="table table-hover table-sm">
                        <thead>
...
@endsection
	...
	<script src="{{ asset('js/reporteComercializacionGeneral.js') }}"></script>
