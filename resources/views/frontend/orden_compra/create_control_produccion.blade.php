...
@section('title', __('Control de Produccion'))
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmOrdenCompraControlProduccion" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="margin-top:15px">
                        <h4 class="card-title mb-0 text-primary" style="font-size:22px">
                            Control de Producci&oacute;n de Orden de Venta
                        </h4>
                    </div>
                </div>
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
						<select name="persona_compra_bus" id="persona_compra_bus" class="form-control form-control-sm">
							<option value="">--Seleccionar Persona Compra--</option>
							<?php
							foreach ($persona_compra as $row){?>
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
						<select name="estado_comprometido_bus" id="estado_comprometido_bus" class="form-control form-control-sm">
							<option value="">--Seleccionar Estado Comprometido--</option>
							<?php
							foreach ($estado_comprometido as $row){?>
                ...
                <div class="card-body">
                    ...
                    <div id="divOrdenCompraControlProduccion" class="table-responsive">
                    <table id="tblOrdenCompraControlProduccion" class="table table-hover table-sm">
                        <thead>
...
@endsection
	...
	<script src="{{ asset('js/ordenCompraControlProduccion.js') }}"></script>
