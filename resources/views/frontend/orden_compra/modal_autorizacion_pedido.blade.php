    ...
    <div>
		...
		<div class="card">
			...
			<div class="card-header" style="padding:5px!important;padding-left:20px!important">
				Historial Autorizaci&oacute;n Pedido
			</div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px">
                ...
                <div class="card-body">
                    ...
                    <table id="tblHistorialProcesoPedido" class="table table-hover table-sm">
                        <thead>
						...
						<?php  
						foreach($historial_autorizacion_pedido as $row){
                        ?>
                        <tr>
                            <td class="text-left" style="vertical-align:middle"><?php echo $row->proceso ?></td>
                            <td class="text-left" style="vertical-align:middle"><?php echo $row->autorizacion ?></td>
                            <td class="text-left" style="vertical-align:middle"><?php echo $row->usuario_autoriza ?></td>
                            <td class="text-left" style="vertical-align:middle"><?php echo $row->fecha_registro ?></td>
                            <td class="text-left" style="vertical-align:middle"><?php echo $row->hora_registro ?></td>
                            <td class="text-left" style="vertical-align:middle"><?php echo $row->fecha_aprobacion ?></td>
                            <td class="text-left" style="vertical-align:middle"><?php echo $row->hora_aprobacion ?></td>
                        </tr>
						<?php 
                        }
						?>
