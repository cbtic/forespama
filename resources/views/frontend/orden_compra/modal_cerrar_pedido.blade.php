...
function fn_save_cerrar_pedido(){
	
    var msg = "";
    
    var motivo = $('#motivo').val();

    if(motivo == ""){msg+="Ingrese un Motivo <br>";}
    ...
    if(msg!=""){
        ...
        $.ajax({
            url: "/orden_compra/send_cerrar_orden_compra_detalle",
            type: "POST",
    ...
    <div>
		...
		<div class="justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                <form method="post" action="#" id="frmCerrarOrdenCompra" name="frmCerrarOrdenCompra">
