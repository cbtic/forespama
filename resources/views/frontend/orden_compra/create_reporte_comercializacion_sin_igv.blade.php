...
@section('title', __('Reporte de Comercializacion General'))
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmReporteComercializacionSinIgv" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="margin-top:15px">
                        <h4 class="card-title mb-0 text-primary" style="font-size:22px">
							Reporte de Comercializaci&oacute;n General Sin IGV
                        </h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <table id="tblReporteComercializacionSinIgv" class="table table-hover table-sm">
                        <thead>
...
@endsection
	...
	<script src="{{ asset('js/reporteComercializacionSinIgv.js') }}"></script>
