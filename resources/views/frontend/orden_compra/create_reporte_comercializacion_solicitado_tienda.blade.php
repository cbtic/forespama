...
@section('title', __('Reporte de Pedidos por Tienda'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Reporte de Comercializaci&oacute;n por Tiendas Solicitado</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmReporteComercializacionTiendaSolicitado" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <table id="tblReporteComercializacionSolicitadoTienda" class="table table-hover table-sm">
                        <thead>
...
@endsection
	...
	<script src="{{ asset('js/reporteComercializacionSolicitadoTienda.js') }}"></script>
