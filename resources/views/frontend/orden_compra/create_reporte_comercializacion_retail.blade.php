...
@section('title', __('Reporte de Comercializacion Retail'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Reporte de Comercializaci&oacute;n Retail</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmReporteComercializacionRetail" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="margin-top:15px">
						...
						<div class="card-header bg-white border-bottom">
							<h5 class="mb-0 text-primary">
								...
								Reporte de Comercializaci&oacute;n Retail
							</h5>
						</div>
                    </div>
                </div>
...
@endsection
	...
	<script src="{{ asset('js/reporteComercializacionRetail.js') }}"></script>
