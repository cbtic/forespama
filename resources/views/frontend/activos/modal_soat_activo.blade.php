...
function fn_save_soat(){
	...
	var estado_soat = $('#estado_soat').val();
	
	if(numero_poliza == "" )msg+="Debe Ingresar un Numero de Poliza <br>";
	...
	if(estado_soat == "")msg+="Debe seleccionar el Estado del SOAT <br>";
    ...
    $.ajax({
		url: "/activos/send_soat_activo",
		type: "POST",
		data : {_token:_token,id:id,
			id_activo:id_activo,numero_poliza:numero_poliza,fecha_emision:fecha_emision,fecha_vencimiento:fecha_vencimiento,estado_soat:estado_soat},
					...
					<div class="row" style="padding-left:10px">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input id="numero_poliza" name="numero_poliza" on class="form-control form-control-sm mayusculas"  value="<?php echo $soat_activo->numero_poliza?>" type="text">
							</div>
						</div>
					</div>
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select name="estado_soat" id="estado_soat" class="form-control form-control-sm">
									<option value="">--Seleccionar--</option>
									<?php 
									foreach ($estado_soat as $row){?>
										<option value="<?php echo $row->codigo ?>" <?php if($row->codigo==$soat_activo->estado_soat)echo "selected='selected'"?>><?php echo $row->denominacion ?></option>
										<?php 
									}
									?>
								</select>
