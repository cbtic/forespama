...
@section('title', __('Entrega de Activos'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Entrega de Activos</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmEntregaActivos" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <input id="descripcion_bus" name="descripcion_bus" on class="form-control form-control-sm"  placeholder="Descripci&oacute;n Activo">
					</div>
                ...
                <div class="card-body">				
                    ...
                    <table id="tblEntregaActivos" class="table table-hover table-sm">
                        <thead>
                        <tr style="font-size:12px">
                            <th>Id</th>
                            <th>Persona</th>
                            <th>N&uacute;mero Documento</th>
                            <th>Descripci&oacute;n Activo</th>
							<th>Marca</th>
							<th>Modelo</th>
							<th>Fecha Entrega</th>
...
@endsection
	...
	<script src="{{ asset('js/entrega_activos.js') }}"></script>
