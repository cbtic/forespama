...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <table style="width:100%; background-color:white !important;border-spacing:1px; width: 100%; margin: 0 auto; font-size:12px; vertical-align:top">
        <tbody>
            <tr>
                <td class="td" style ="text-align: left; width: 10%;">Fecha de Emisi&oacute;n:</td>
                <td class="td" style ="text-align: left; width: 20%;"><?php echo $fecha_emision;?></td>
            </tr>   
        </tbody>
    </table>
    <table style="width: 100%; border-collapse: separate; border-spacing: 0 10px;">
        <tr>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia">Punto de partida: <?php echo $punto_partida;?></p>
            </th>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia">Punto de llegada: <?php echo $punto_llegada;?></p>
            </th>
        </tr>
        <tr>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia">Fecha de Inicio de Traslado: <?php echo $fecha_traslado;?></p>
            </th>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
        ...
        <tr>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia" style="text-align: center; font-size: 11px; margin: 0;"><b>UNIDAD DE TRANSPORTE Y CONDUCTOR</b></p>
                <div style="border-top: 1px solid black; margin: 5px 0; width: 100%;"></div>
                <p class="info-guia">Marca y numero de placa: <?php echo $marca;?> / <?php echo $placa;?></p>
                <p class="info-guia">N° de Contancia de Inscripcion: <?php echo $constancia_inscripcion;?></p>
                <p class="info-guia">N° (s) de Licencia(s) de Conducir: <?php echo $licencia_conducir;?></p>
            </th>
            <th style="text-align: left; border: solid 1px black; border-radius: 8px; background-color: white; vertical-align: top; width: 49%">
                <p class="info-guia" style="text-align: center; font-size: 11px"><b>EMPRESA DE TRANSPORTES</b></p>
                <div style="border-top: 1px solid black; margin: 5px 0; width: 100%;"></div>
                <p class="info-guia">RAZON SOCIAL: <?php echo $empresa_transporte;?></p>
                <p class="info-guia">Numero de R.U.C.: <?php echo $ruc_empresa_transporte;?></p>
            </th>
        </tr>
    </table>
            ...
            <table class="data" style="border-collapse: separate; border-spacing: 0; background-color:white !important; width: 100%; border-radius: 8px; font-size:11px">
                <tbody>
                    <tr class="data">
                        ...
                        <td class="td" style ="text-align: left; width: 10%; height:25px; border-bottom: 1px solid black;"><b>C&oacute;DIGO</b></td>
                        <td class="td" style ="text-align: left; width: 65%; height:25px; border-bottom: 1px solid black;"><b>DESCRIPCI&Oacute;N</b></td>
                    ...
                    foreach($datos_detalle as $key=>$r) { ?>
                        <tr>
                            ...
                            <td class="td" style ="text-align: left; width: 65%; height:25px"><?php echo $r->producto; if($id_destinatario==$r->id_empresa) echo " (".$r->codigo_empresa." - ".$r->descripcion_empresa.")"?> </td>
