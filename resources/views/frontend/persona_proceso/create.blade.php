...
@section('title', __('Consulta Personas por Proceso'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Asignaci&oacute;n de Personas por Proceso</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmPersonaProceso" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="margin-top:15px">
                        <h4 class="card-title mb-0 text-primary" style="font-size:22px">
                            Asignaci&oacute;n de Personas por Proceso
                        </h4>
                    </div>
                </div>
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						<select name="user_bus" id="user_bus" class="form-control form-control-sm">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
						<select name="proceso_bus" id="proceso_bus" class="form-control form-control-sm">
                ...
                <div class="card-body">				
                    ...
                    <table id="tblPersonaProceso" class="table table-hover table-sm">
                        <thead>
...
@endsection
	...
	<script src="{{ asset('js/persona_procesos.js') }}"></script>
