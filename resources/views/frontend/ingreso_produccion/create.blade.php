...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    ...
    <li class="breadcrumb-item active">Registro de Ingresos a Producci&oacute;n</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmIngresoProduccion" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                        <input id="numero_ingreso_produccion_bus" name="numero_ingreso_produccion_bus" on class="form-control form-control-sm"  placeholder="N&uacute;mero Dispensaci&oacute;n">
					</div>
                ...
                <div class="card-body">
                    ...
                    <table id="tblIngresoProduccion" class="table table-hover table-sm">
                        <thead>
...
@endsection
	...
	<script src="{{ asset('js/ingresoProduccion.js') }}"></script>
