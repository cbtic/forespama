...
function fn_save_tienda(){

    $('#denominacion').val($('#denominacion').val().toUpperCase());
	
	$.ajax({
			url: "/tiendas/send_tienda",
            type: "POST",
            data : $("#frmTienda").serialize(),
...
function datatableTiendaDetalle(){
	
	var empresa =  $('#empresa').val();
	
    $("#tblTablaTiendaDetalle tbody").html("");
	$.ajax({
			url: "/tiendas/obtener_datos_tienda/"+empresa,
			type: "GET",
			success: function (result) {
    ...
    <div>
		...
		<div class="justify-content-center">		
            ...
            <div class="card">
                ...
                <div class="card-body">
                <form method="post" action="#" id="frmTienda" name="frmTienda">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="empresa" id="empresa" class="form-control form-control-sm" onchange="datatableTiendaDetalle()">
                                            ...
                                            foreach ($empresa as $row){?>
                                                <option value="<?php echo $row->id ?>" <?php if($row->id==$tienda_detalle->id_empresa)echo "selected='selected'"?>><?php echo $row->razon_social ?></option>
                                             <?php 
                                            }
                                            ?>
                                        </select>
                        ...
                        <div style="margin-top:15px" class="form-group">
                            <div class="col-sm-12 controls">
                                <div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
                                    ...
                                    <button type="button" style="font-size:12px;margin-left:10px" class="btn btn-sm btn-clasico btn-nuevo" data-toggle="modal" onclick="fn_save_tienda()">
                                ...
                                <button type="button" style="font-size:12px;margin-left:10px" class="btn btn-sm btn-clasico btn-cerrar" data-toggle="modal" onclick="$('#openOverlayOpc').modal('hide');window.location.reload();">
