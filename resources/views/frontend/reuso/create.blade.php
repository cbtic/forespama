...
@section('title', __('Reuso'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Reuso</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmReuso" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                        <input id="numero_reuso_bus" name="numero_reuso_bus" on class="form-control form-control-sm"  placeholder="N&uacute;mero Reuso">
					</div>
                ...
                <div class="card-body">
                    ...
                    <table id="tblReuso" class="table table-hover table-sm">
                        <thead>
                        <tr style="font-size:13px">
                            <th>Id</th>
                            <th>Fecha</th>
							<th>N&uacute;mero Reuso</th>
...
@endsection
	...
	<script src="{{ asset('js/reuso.js') }}"></script>
