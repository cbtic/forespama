...
@section('title', __('Asiento Contable Anexos'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Generar Asientos Contables de Anexos</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmAsientoContableAnexo" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<input id="razon_social_bus" name="razon_social_bus" on class="form-control form-control-sm filtro-input"  placeholder="Raz&oacute;n Social">
							</div>
                ...
                <div class="card-body">				
                    ...
                    <table id="tblAsientoContableAnexo" class="table table-hover table-sm">
                        <thead>
...
@endsection
	...
	<script src="{{ asset('js/asiento_contable_anexo.js') }}"></script>
