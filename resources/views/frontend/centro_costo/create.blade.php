...
@section('title', __('Consulta Centro de Costos'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Centro de Costos</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmCentroCosto" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="row justify-content-center" style="margin-top:15px">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<div class="row">
							...
							<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
								<select name="operacion_bus" id="operacion_bus" class="form-control form-control-sm filtro-select">
									<option value="">--Seleccionar Operaci&oacute;n--</option>
									<?php
				...
				<div class="card-body">				
					...
					<table id="tblCentroCosto" class="table table-hover table-sm">
						<thead>
...
<script src="{{ asset('js/centroCosto.js') }}"></script>
