...
@section('title', __('Consulta Sub Familias'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Sub Familias</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmSubFamilia" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
						<select name="familia_bus" id="familia_bus" class="form-control form-control-sm">
                ...
                <div class="card-body">				
                    ...
                    <table id="tblSubFamilias" class="table table-hover table-sm">
                        <thead>
...
@endsection
	...
	<script src="{{ asset('js/sub_familia.js') }}"></script>
