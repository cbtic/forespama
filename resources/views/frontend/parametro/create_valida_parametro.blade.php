...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    ...
    <li class="breadcrumb-item active">Verificacion de Aplicacion Orden Compra</li>
    </li>
</ol>
...
<div class="justify-content-center">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmIngreso" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="card">
						<div class="card-header">
							<strong>
								Verificaci&oacute;n de Aplicaci&oacute;n de Comisiones
							</strong>
						</div>

						<div class="card-body">
							
							<div id="divValidaParametro" class="table-responsive overflow-auto" style="max-height: 500px">
	...
	<script src="{{ asset('js/parametro_valida.js') }}"></script>
