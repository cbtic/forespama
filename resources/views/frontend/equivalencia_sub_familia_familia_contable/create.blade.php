...
@section('title', __('Consulta Equivalencia Familia Contable'))

@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
    <li class="breadcrumb-item text-primary">Inicio</li>
    <li class="breadcrumb-item active">Registro de Equivalencia Familia Contable</li>
    </li>
</ol>
...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmEquivalenciaFamiliaContable" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="margin-top:15px">
					<h4 class="card-title mb-0 text-primary" style="font-size:22px">
						Equivalencia de Familia Contable
					</h4>
				</div>
			</div>
			<div class="row justify-content-center" style="margin-top:15px">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<div class="row">
							<!--<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
								<input id="periodo_bus" name="periodo_bus" on class="form-control form-control-sm filtro-input"  placeholder="Periodo">
							</div>-->
							...
							<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
								<select name="sub_familia_bus" id="sub_familia_bus" class="form-control form-control-sm filtro-select">
									...
									foreach ($sub_familia as $row){?>
										<option value="<?php echo $row->id ?>"><?php echo $row->sub_familia ?></option>
										<?php 
									}
									?>
								</select>
							...
							<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
								<select name="familia_contable_bus" id="familia_contable_bus" class="form-control form-control-sm filtro-select">
									<option value="">--Seleccionar Familia Contable--</option>
									<?php
				...
				<div class="card-body">				
					...
					<table id="tblEquivalenciaFamiliaContable" class="table table-hover table-sm">
						<thead>
...
<script src="{{ asset('js/equivalenciaFamiliaContable.js') }}"></script>
