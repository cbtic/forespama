            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px">
                ...
                <div class="card-body">				
                    ...
                    <table id="tblPuesto" class="table table-hover table-sm">
						...
						<?php  
						foreach($ingresoVehiculoTroncoImagen as $row){
						?>
						<tr>
							<td class="text-left" style="vertical-align:middle"><?php //echo $row->tipo_documento?>
							<img src="<?php echo $row->ruta_imagen?>" width="130px" height="165px" alt="" style="text-align:center;margin-top:8px;margin-left:10px" />
							</td>
							<td class="text-left" style="vertical-align:middle">
								<a href="<?php echo $row->ruta_imagen?>" target="_blank" class="btn btn-sm btn-info">Ver Imagen</a>
							</td>
						</tr>
						<?php 
							}	
