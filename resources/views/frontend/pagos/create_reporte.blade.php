...
<div class="justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" action="" id="frmReportePagos" autocomplete="off" enctype="multipart/form-data">
				<!--
                <div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="card">
									...
									<div class="card-header">
										<strong>Reporte de Cubicaci&oacute;n</strong>
									</div>
								
									<div id="divTablaReporteCubicaje" class="row col align-self-center" style="padding:10px 20px 10px 20px;">
									...
									<div class="row">
										<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
											<div class="card">
												...
												<!--table-hover-grid-->
													<table id="tblReporteCubicaje" class="table table-hover table-sm">
														<thead>
															<tr style="font-size:13px">
																<!--<th>N°</th>
																<th>Id</th>-->
																<th width="10%">Fecha Recepci&oacute;n</th>
										...
										<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
											...
											<div class="card">
												...
												<div class="card-body">
													...
													<div id="divReportePagos" class="table-responsive overflow-auto" style="max-height: 600px">
														<table id="tblReportePagos" class="table table-hover table-sm">
															<thead>
																<tr style="font-size:13px">
	...
	<script src="{{ asset('js/pagos/reporte_pagos.js') }}"></script>
