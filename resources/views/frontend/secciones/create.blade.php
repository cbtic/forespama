            ...
            <form class="form-horizontal" method="post" action="" id="frmAlmacenes" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<input class="form-control form-control-sm" id="almacen_bus" name="almacen_bus" placeholder="Denominacion">
					</div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <input id="codigo_bus" name="codigo_bus" on class="form-control form-control-sm"  placeholder="Encargado">
					</div>
                ...
                <div class="card-body">				
                    ...
                    <table id="tblSecciones" class="table table-hover table-sm">
                        <thead>
                        <tr style="font-size:13px">
                            <th>Id</th>
							<th>C&oacute;digo Almacen</th>
                            <th>Almacen</th>
							<th>C&oacute;digo Secci&oacute;n</th>
...
@endsection
	...
	<script src="{{ asset('js/secciones.js') }}"></script>
