...
<tr style="font-size:13px" class="test" data-toggle="tooltip" data-placement="top">
	...
	<td class="text-right"><input class="form-control form-control-sm text-right" name="diametro_dm[]" value="<?php echo ($row->diametro_dm!=0)? number_format($row->diametro_dm,2):""?>" readonly="readonly"></td>
