...
<html lang="es">
    <head>
        ...
        <title>Acceso Denegado | FORESPAMA</title>
    ...
    <body>
        <div class="navbar-brand" style="background:#183e39!important;padding:0.7rem 1rem">
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="details">No tiene permisos para acceder a este m&oacute;dulo del sistema.</div>
